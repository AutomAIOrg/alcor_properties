...
class TestBuildCleaningOpportunities:
    ...
    def test_marks_has_bill_for_billed_bookings_only(self):
        bookings = [
            make_booking(
                record_id=1,
                apartment_id="R180",
        ...
        opportunities = _build_cleaning_opportunities(bookings, billed_booking_ids={1})

        by_id = {o.source_booking_record_id: o for o in opportunities}
        assert by_id[1].has_bill is True
        assert by_id[2].has_bill is False

    def test_has_bill_defaults_to_false_without_billed_ids(self):
        bookings = [
            make_booking(
                record_id=1,
                apartment_id="R180",
        ...
        assert opportunities[0].has_bill is False

    def test_can_bill_true_when_checkout_already_passed(self):
        bookings = [
            make_booking(
                record_id=1,
                apartment_id="R180",
        ...
        opportunities = _build_cleaning_opportunities(
            bookings, reference_datetime=datetime(2026, 6, 5, 12, 0)
        )

        assert opportunities[0].can_bill is True

    def test_can_bill_false_when_checkout_today_before_default_time(self):
        bookings = [
            make_booking(
                record_id=1,
                apartment_id="R180",
        ...
        opportunities = _build_cleaning_opportunities(
            bookings, reference_datetime=datetime(2026, 6, 5, 9, 0)
        )

        assert opportunities[0].can_bill is False

    def test_can_bill_false_for_future_checkout(self):
        bookings = [
            make_booking(
                record_id=1,
                apartment_id="R180",
        ...
        opportunities = _build_cleaning_opportunities(
            bookings, reference_datetime=datetime(2026, 6, 4, 23, 0)
        )
